...
quant_intra_8x8 = [16, 16, 16, 16, 17, 18, 21, 24,
...
intra_factor = lambda multiplier: [(16 / factor) ** multiplier for factor in quant_intra_8x8]

quant_inter_8x8 = [16, 16, 16, 16, 17, 18, 20, 24,
...
inter_factor = lambda multiplier: [(16 / factor) ** multiplier for factor in quant_inter_8x8]
...
def adaptive_grain(
    ...
    **kwargs,
    ...
    grained = core.akarin.Expr([grained, static_grained, lowpassed_static_grained], "x y z - +")
